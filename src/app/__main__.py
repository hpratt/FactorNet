...
def main():
    ...
    core.add_argument("--rDHSs", type = str, help = "path to rDHS regions to which features correspond")
    core.add_argument("--feature-files", type = str, nargs = '+', help = "path to feature matrices in JSON format")
    core.add_argument("--sequence-matrix", type = str, help = "path to one-hot sequence matrix for rDHSs")
    core.add_argument("--signal-z-scores", type = str, help = "path to BED file containing TF Z-scores for each rDHS")
